...
#perturb value
perturb_value = int(param6) # Value of the perturbation 30 #in pA
...
folder_perturb='Sim_e4_'+str(ff_value)+'pA_e5_'+str(fb_value_5)+'pA_pert_'+str(perturb_value)+'pA'
#Files where you want to save the output of the simulation
a='../simulations_data/REVISIONS_1/'+folder_perturb+'/'+str(folder_spikes) 
