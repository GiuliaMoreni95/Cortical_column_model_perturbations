...
LAYER= int(param2) #0
CELL_TYPE= int(param3) #0

#FF input
ff_value = int(param4) #30 #FF input
ff_value_pv = ff_value
#FB input 
fb_value_5= int(param5) # 0 #FB input
fb_value_pv_5 =fb_value_5

fb_value_23 = int(param6)
fb_value_pv_23= fb_value_23 

fb_value_6 = int(param7)
...
folder_state='TIMING_e4_'+str(ff_value)+'pA_e5_'+str(fb_value_5)+'pA_e23_'+str(fb_value_23)+'pA_e6_'+str(fb_value_6)+'pA'
#Files where you want to save the output of the simulation
a='../simulations_data/REVISIONS_1/'+folder_state+'/'+str(folder_spikes) 
...
pops[LAYER][CELL_TYPE][:].I_ext1=- perturb_value * pA 

# #LATER 4
# if LAYER==1 and CELL_TYPE==0:
#     pops[1][0][:int(N[1][0]/(100/portion_e4))].I_ext1= - (perturb_value+ff_value) * pA
# if LAYER==1 and CELL_TYPE==1:
#     pops[1][1][:int(N[1][1]/(100/portion_pv4))].I_ext1= - (perturb_value+ff_value_pv) * pA
    
# #LATER 5
# if LAYER==2 and CELL_TYPE==0:
#     pops[2][0][:int(N[2][0]/(100/portion_e5))].I_ext1= - (perturb_value+fb_value_5) * pA

# if LAYER==2 and CELL_TYPE==1:
#     pops[2][1][:int(N[2][1]/(100/portion_pv5))].I_ext1= - (perturb_value+fb_value_pv_5) * pA


# #LATER 2/3
# if LAYER==0 and CELL_TYPE==0:
#     pops[0][0][:int(N[0][0]/(100/portion_e23))].I_ext1= - (perturb_value+fb_value_23) * pA

# if LAYER==0 and CELL_TYPE==1:
#     pops[0][1][:int(N[0][1]/(100/portion_pv23))].I_ext1= - (perturb_value+fb_value_pv_23) * pA

# #LATER 6
# if LAYER==3 and CELL_TYPE==0:
#     pops[3][0][:int(N[3][0]/(100/portion_e6))].I_ext1= - (perturb_value+fb_value_6) * pA

# if LAYER==3 and CELL_TYPE==1:
#     pops[3][1][:int(N[3][1]/(100/portion_pv6))].I_ext1= - (perturb_value+fb_value_pv_6) * pA
