...
#Input to the column
ff_value = int(param1)  #FF input
ff_value_pv = int(ff_value/4) #FF input

fb_value_5 = int(param2)
fb_value_pv_5= fb_value_5  

fb_value_23 = int(param3) 
fb_value_pv_23= fb_value_23 

fb_value_6 = int(param4) 
...
# a ='../simulations_data/REVISIONS_1/reproduce_mean_FR/Sp_input_e4_'+str(ff_value)+'pA_e5_'+str(fb_value_5)+'pA_e23_'+str(fb_value_23)+'pA_e6_'+str(fb_value_6)+'pA'
...
a ='../simulations_data/REVISIONS_1/reproduce_mean_FR/Sp_input_e4_'+str(ff_value)+'pA_e5_'+str(fb_value_5)+'pA_pv4_'+str(ff_value_pv)+'pA_pv5_'+str(fb_value_pv_5)+'pA_prop_pv4_'+str(portion_pv4)
